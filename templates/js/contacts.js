...
/**
 * Initializes the contacts by loading them, rendering the contacts section, and rendering the contacts list.
...
/**
 * Prevents the contact overlay from closing when an event occurs.
